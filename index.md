...
My research interests covered a broad spectrum, but I am currently focusing on cybersecurity (partly funded by the Department of Industry, Science and Resources through the [Critical Technologies Challenge Program](https://www.industry.gov.au/science-technology-and-innovation/industry-innovation/critical-technologies-challenge-program)), machine-learning-based applications for space systems (partly funded by the Department of Education through [iLAuNCH](https://ilaunch.space/)), adversarial machine learning (partly funded by [AOARD](https://www.afrl.af.mil/)), as well as machine prognostics and health management (partly funded by [SA Water](https://www.sawater.com.au/)).

I was involved with numerous European projects on sensor networks, including EYES, SENSEI, Internet of Things Initiative, SmartSantander and SocIoTal; in particular, I was a Chief Investigator in the last three projects. In Australia, I was involved with ARC-funded sensor network and smart city testbed projects. I am serving on the editorial board for [International Journal of Distributed Sensor Networks](https://journals.sagepub.com/home/dsn) and [Journal of Computer Security and Data Forensics](https://jcsdf.sdust.edu.cn/). My publications can be found in ACM Transactions, IEEE Transactions, IEEE Magazines, EURASIP Journals and more, earning me a [Google Scholar H-index of 28](https://scholar.google.com/citations?user=cJTPOloAAAAJ).

See my up-to-date [list of publications](https://ywlaw.github.io/pub/ywlaw.pdf).
...
| [EEET 3016 Power Electronics](https://study.unisa.edu.au/courses/010830) | 2021-2025 |
| EEET 3046 Control Systems | 2014-2020 |
| EEET 4071 Advanced Control | 2014-2021 |

 A common thread in my teaching is model-based design, supported by analytical problem solving and computational thinking.

# Misc

On 5 December 2021, I co-founded [Mesh in Space](https://meshin.space). On 9 February 2022, Mesh in Space was admitted into the [Venture Catalyst Space](https://icc.unisa.edu.au/programs/venture-catalyst-space) program. However, on 8 February 2023, all co-founders decided to take a break from the start-up scene and focus on research. 